...
object TestTags {
    ...
    /**
     * 気づいたものを足すシート（画面 05）と、04 にあるその入口。
     *
     * **区切りは 04 と別のタグにする。** シートは 04 の上に重なるので、同じタグだと
     * 下の一覧の区切りと 2 つ見つかって `onNodeWithTag` が落ちる。
     */
    ...
    const val ADD_NOTICED_SECTION_ANYWHERE = "add_noticed_section_anywhere"
